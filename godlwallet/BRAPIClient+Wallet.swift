...
private let goldcoinMultiplierURL = "https://api.coinmarketcap.com/v1/ticker/goldcoin/"
...
extension BRAPIClient {
    ...
    func goldcoinMultiplier(_ handler: @escaping (_ mult: Double, _ error: String?) -> Void) {
        let request = URLRequest(url: URL(string: goldcoinMultiplierURL)!)
            ...
            do {
                ...
                if error == nil, let data = data,
                    ...
                    guard let arr = parsedData.first else {
                        return handler(0.00, "\(String(describing: self.goldcoinMultiplier)) didn't return an array")
                    }
